...
typedef struct
{
	...
	float target_postion; /*motor target position*/
	float target_speed;	/*motor target speed*/
	float target_torque;	/*motor target torque*/
	float speed_offset;	/*motor speed offset*/
	float torque_offset;	/*motor torque offset*/
	float kp;
	float kd;
	bool disenable;
} MOTOR_REFERENCE;
...
typedef struct
{
	...
	float feedbk_postion; /*Feed back position*/
	float feedbk_speed;	/*Feed back speed*/
	float feedbk_torque;	/*Feed back torque*/
	float target_position;
	float target_torque_offset;	
